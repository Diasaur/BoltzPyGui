...
class Window(QWidget):
    """To Do:
    -outsourcing check functions? either from config (valid_x) or separate file with methods --> smaller checks here (if check.isInt(argument))
    -for that wait if and how thosse wants to do add validators in his classes (doesnt need unnecessary doubling)
    """
    ...
    def __init__(self, parent):
        ...
        self.list_alpha = [QLineEdit() for i in range(0, self.parent.cnf.s.n + 1)]
